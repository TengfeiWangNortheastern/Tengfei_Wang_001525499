...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    public CreateNewProductJPanel(JPanel upc, UserAccount s,FoodCatalog foodCatalog){
        initComponents();
...
//get value from textbox and convert
        double price =0.0;
        int quantity=0;
        try{
            price=Double.parseDouble(txtPrice.getText());
            quantity=Integer.parseInt(this.txtAvailability.getText());
        }catch(Exception e){
...
//        }
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        ManageFoodCatalogJPanel manageProductCatalogJPanel = (ManageFoodCatalogJPanel) component;
