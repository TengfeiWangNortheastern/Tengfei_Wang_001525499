...
public class VitalSigns {
    ...
    public void setWeightInKilos(double weightInKilos) {
        ...
        setWeightInPounds(weightInKilos*2.2);
    }
    ...
    public boolean[] areTheSignsNormal(){
        //get the boolean list for each vital sign
...
//            return "Abnormal VitalSigns " + "ageGroup=" + ageGroup + ", respiratoryRate=" + respiratoryRate + ", heartRate=" + heartRate + ", systolicBloodPressure=" + systolicBloodPressure + ", weightInKilos=" + weightInKilos + ", weightInPounds=" + weightInPounds;
        return  "VitalSigns: ageGroup=" + ageGroup + ", respiratoryRate=" + respiratoryRate + ", heartRate=" + heartRate + ", systolicBloodPressure=" + systolicBloodPressure + ", weightInKilos=" + String.format("%.2f",weightInKilos) + ", weightInPounds=" + String.format("%.2f", weightInPounds) ;
    }

    public boolean signNormal() {
        boolean signNormal=true;
        for(boolean b:areTheSignsNormal()){
            if(b==false){
                signNormal=b;
                break;
            }
...
//get true or false if the vital signs are normal
}
