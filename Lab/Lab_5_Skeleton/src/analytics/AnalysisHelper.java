...
public class AnalysisHelper {
    ...
    public void getAverageLikesPerComments() {
        ...
        System.out.println("Q1_Average number of likes per comments: " + likeNumber / commentNumber);
    ...
    public void getPostWithMostComments(){
        ...
        System.out.println("Q3_postWithMostComents: "+postWithMostComments.getPostId());
    }
    public void getPassiveUsrs(){
        DataStore data=DataStore.getInstance();
        ...
        System.out.println("Q4-The following users have the least 5 posts: ");
        for(int i=0;i<5;i++){
    ...
    public void getPassiveAndActiveOverallUsers(){
        ...
        System.out.println("Q6_The fllowing users have overall been passive: ");
        for(int i=0;i<5;i++){
            System.out.println(users.get(i)+", overall count: "+overallNumbers.get(users.get(i).getId()));
    }
        System.out.println("Q7_The following users have overall been active; ");
